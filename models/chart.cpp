...
///////////////////////////// chartModel ////////////////////////////
  ...
  chartModel::chartModel(BlockData& bd,U32 val):x(bd),buf(bd.buf),
  cm(x,30,CMlimit(x.MEM()*4)),
  cn(x,20,CMlimit(x.MEM())), 
  //cm(CMlimit(x.MEM()*4),30,M_CHART),
  //cn(CMlimit(x.MEM()),20,M_CHART), 

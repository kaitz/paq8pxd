...
wavModel1::wavModel1(BlockData& bd): x(bd),buf(bd.buf){
    ...
    mxp.push_back( {8192,64,0,28,&mxcxt[0],0} ); // 4096 8192
    mxp.push_back( {4096,64,0,28,&mxcxt[1],0} ); // 2048 4096
    mxp.push_back( {2560,64,0,28,&mxcxt[2],0} ); // 1280 2560
    mxp.push_back( { 256,64,0,28,&mxcxt[3],0} ); //  256  256
    mxp.push_back( {  20,64,0,28,&mxcxt[4],0} ); //   10   20
}

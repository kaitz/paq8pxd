...
typedef enum {DEFAULT=0,BINTEXT,ISOTEXT,DBASE, JPEG, HDR,CMP,IMGUNK, IMAGE1,IMAGE4, IMAGE8,IMAGE8GRAY, IMAGE24,IMAGE32, AUDIO, EXE,DECA,ARM,
              ...
              ZLIB,PREFLATE,ZIP,GZIP,MDF,MSZIP,EOLTEXT,DICTTXT,BIGTEXT,NOWRT,TAR,PNG8,IMPNG8,IMPNG8GRAY, PNG8GRAY,IMPNG24,PNG24,IMPNG32,PNG32,RECE,WIT,
              ISO9960,ISCAB,SHRINK,REDUCE,IMPLODE,BM8_IMG,BM4_IMG,BM8_OS2,BM4_OS2,TYPELAST} Filetype;

static const int datatypecount=63;
...
static const char* typenames[datatypecount]={"default","bintext","ISO text","dBase", "jpeg", "hdr", "cmp","imgunk","1b-image", "4b-image", "8b-image","8b-gimage", "24b-image","32b-image", "audio",
                                ...
                                "DICTTXT","BIGTEXT","NOWRT","tar","PNG8","IMPNG8","IMPNG8G","PNG8G","IMPNG24","PNG24","IMPNG32","PNG32","Recursive","WIT","ISO9960","IS-CAB","SHRINK","REDUCE","IMPLODE","BM8_IMG","BM4_IMG","BM8_OS2",
                                "BM4_OS2"};
...
typedef enum  {SLOW=1, EXTREME=2} CMode;

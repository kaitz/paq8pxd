...
static const int datatypecount=61;
...
static const char* typenames[datatypecount]={"default","bintext","ISO text","dBase", "jpeg", "hdr", "cmp","imgunk","1b-image", "4b-image", "8b-image","8b-gimage", "24b-image","32b-image", "audio",
                                ...
                                "DICTTXT","BIGTEXT","NOWRT","tar","PNG8","PNG8G","IMPNG24","PNG24","IMPNG32","PNG32","Recursive","WIT","ISO9960","IS-CAB","SHRINK","REDUCE","IMPLODE","BM8_IMG","BM4_IMG","BM8_OS2",
                                "BM4_OS2"};

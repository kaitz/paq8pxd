...
BlockData::BlockData(Settings &set):settings(set), wrtpos(0),wrtfile(0),wrtsize(0),wrtcount(0),wrtdata(0),wrtLoaded(false),wrtText(255),wrtTextSize(0),wrtstatus(0),wrtbytesize(0),
y(0), c0(1), c4(0),c8(0),bpos(0),blpos(0),rm1(1),filetype(DEFAULT),
    ...
    pwords(0),pbc(0),bc4(0),istex(true),ishtml(false),cxt(16)
   {
       ...
       memset(&x86_64, 0, sizeof(x86_64));
        ...
        if (settings.level>=11) buf.setsize(0x20000000); //limit 512mb
